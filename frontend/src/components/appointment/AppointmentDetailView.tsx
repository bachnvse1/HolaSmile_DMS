  ...
  const handleConfirmStatusChange = () => {
    ...
    changeStatus(
      { appointmentId, status: confirmModal.status },
      {
        ...
        onError: (error) => {
          toast.error(
            getErrorMessage(error) || "Có lỗi xảy ra khi cập nhật trạng thái"
          );
          setConfirmModal({
            isOpen: false,
            status: null,
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1 text-sm sm:text-base">
              Thông tin chi tiết về lịch hẹn #{appointment.appointmentId}
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-gray-900 font-bold whitespace-pre-wrap break-words word-wrap overflow-wrap-anywhere ">
                      {appointment.content}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900">
                      {formatDateVN(appointment.createdAt)}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
              ...
              {isPrescriptionLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-xs text-gray-600">
                    ...
                    <span>
                      Ngày tạo: {formatDateVN(prescription.createdAt)}
                    </span>
                  </div>
                </div>
              ) : (
      ...
      <ConfirmModal
        ...
        confirmVariant={
          confirmModal.status === "attended" ? "default" : "destructive"
        }
